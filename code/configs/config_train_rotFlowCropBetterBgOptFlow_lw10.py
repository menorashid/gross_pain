...
config_dict['label_types_train'] += ['opt_flow']
config_dict['label_types_test'] += ['opt_flow']
config_dict['training_set'] = 'LPS_10fps_crop_ofp_0.01'
config_dict['csv_str_aft'] = '_optreduced_reduced_percent_0.01_frame_index.csv'
