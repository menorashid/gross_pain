...
def vis_segmentation(image, seg_map, out_file):
...
def run_visualization(model, url, out_file):
    ...
    seg_map[seg_map<12] = 0
    seg_map[seg_map>13] = 0
...
# model_dir = '../data'
# _TARBALL_NAME = 'deeplab_'+MODEL_NAME+'.tar.gz'
# # tempfile.mkdtemp()
# util.makedirs(model_dir)
...
# print (image_url)
# out_file = '../scratch/deeplab_test.jpg'
# run_visualization(MODEL, image_url, out_file)
